...
void IRCMessage::setIntCommand()
{
	...
	switch (cmd)
	{
		CMDCASE(001, RPL_WELCOME);
		CMDCASE(002, RPL_YOURHOST);
		CMDCASE(003, RPL_CREATED);
		CMDCASE(004, RPL_INFO);
		CMDCASE(005, RPL_BOUNCE);
		CMDCASE(221, RPL_UMODEIS);
		CMDCASE(251, RPL_INFO);
		CMDCASE(252, RPL_INFO);
		CMDCASE(253, RPL_INFO);
		CMDCASE(254, RPL_INFO);
		CMDCASE(255, RPL_INFO);
		CMDCASE(265, RPL_INFO);
		CMDCASE(266, RPL_INFO);
